...
from fairseq.data import (
    data_utils, Dictionary, LanguageTripleDataset, IndexedInMemoryDataset,
...
class TranslationContextTask(FairseqTask):
    ...
    def load_dataset(self, split):
        ...
        self.datasets[split] = LanguageTripleDataset(
            ...
            ctx_dataset, ctx_dataset.sizes, self.ctx_dict,
            left_pad_source=self.args.left_pad_source,
            left_pad_target=self.args.left_pad_target,
            left_pad_context=self.args.left_pad_context,
            max_source_positions=self.args.max_source_positions,
            max_target_positions=self.args.max_target_positions,
            max_context_positions=self.args.max_context_positions,
        )
