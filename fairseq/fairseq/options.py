...
def add_dataset_args(parser, train=False, gen=False):
    ...
    if train:
        ...
        group.add_argument('--alignfile', metavar='ALIGN', default=None, help='an alignment file (optional: for edit weighted cross entropy loss)')
    if gen:
...
def add_interactive_args(parser):
    ...
    group.add_argument('--input-files', nargs='+', help='input list of files for other tasks (default: takes input from standard input)')
